...
st.markdown(
    ...
    <div style="display: flex; align-items: center;">
        <img src="data:image/png;base64,{logo_data}" style="max-height:40px; height:40px; width:auto; margin-right:10px;; margin-top:0px;; margin-bottom:40px;">
        <span style="font-family: Roboto, sans-serif; font-weight: bold; font-size:26px; color:#007C71;">
